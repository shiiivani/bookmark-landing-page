  ...
  return (
    <div className="App">
      ...
      <div className="section2">
        <h2>Features</h2>
        <p className="feature-content">Our is to make it quick and easy for you to access your<br /> favourite devices. Your bookmarks sync between your devices<br /> so you can access them on the go.</p>
      ...
      <div className="section3">
        ...
        <p className="para">We've got more browsers in the pipeline. Please do let us know if<br /> you've got a favourite you'd like us to prioritize.</p>
